(() => {
  ...
  const buildTodoCard = (todo) => {
    const htmlString = `
    <article class="todo rounded flex-col justify-center my-2" completed="${todo.completed}" alt="${todo.id}">
